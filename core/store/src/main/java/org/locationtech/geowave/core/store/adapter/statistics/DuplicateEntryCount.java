...
public class DuplicateEntryCount<T> extends
  ...
  public DuplicateEntryCount(final Short internalDataAdapterId, final String indexName) {
    super(internalDataAdapterId, STATS_TYPE, indexName);
  }
  ...
  public byte[] toBinary() {
    ...
    final ByteBuffer buf =
        super.binaryBuffer(VarintUtils.unsignedLongByteLength(entriesWithDuplicates));
    VarintUtils.writeUnsignedLong(entriesWithDuplicates, buf);
    return buf.array();
  }
