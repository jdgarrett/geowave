...
public class FieldMappedVisibilityHandler implements VisibilityHandler {
  ...
  public byte[] toBinary() {
    ...
    while (!byteQueue.isEmpty()) {
      final byte[] bytes = byteQueue.poll();
