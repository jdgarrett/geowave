  ...
  public GeoWaveMetadata next() {
    ...
    while (it.hasNext()) {
      ...
      if (currentStatistics == null) {
        ...
        if (statEntry.getType().equals(currentStatistics.getType())
            && statEntry.getAdapterId().equals(currentStatistics.getAdapterId())
            && statEntry.getExtendedId().equals(currentStatistics.getExtendedId())) {
