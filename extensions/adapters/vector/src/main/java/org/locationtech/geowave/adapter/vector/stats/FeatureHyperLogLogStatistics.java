...
public class FeatureHyperLogLogStatistics extends
  ...
  public FeatureHyperLogLogStatistics(final String fieldName, final int precision) {
    this(null, fieldName, precision);
  }
  ...
  public String toString() {
    ...
    buffer.append("hyperloglog[internalDataAdapterId=").append(super.getAdapterId());
    buffer.append(", field=").append(getFieldName());
    buffer.append(", cardinality=").append(loglog.cardinality());
    buffer.append("]");
  ...
  protected Object resultsValue() {
    ...
    result.put("cardinality", loglog.cardinality());

    result.put("precision", (long) precision);
    return result;
  }

  public static class FeatureHyperLogLogConfig implements StatsConfig<SimpleFeature> {
    /** */
