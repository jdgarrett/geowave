...
public class FeatureNumericRangeStatistics extends
  ...
  public FeatureNumericRangeStatistics(final Short adapterId, final String fieldName) {
  ...
  public String toString() {
    ...
    buffer.append("range[internalDataAdapterId=").append(super.getAdapterId());
  ...
  public static class FeatureNumericRangeConfig implements StatsConfig<SimpleFeature> {
    /** */
